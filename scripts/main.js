...
define('collections/EntityCollection',[
...
define('tpl!templates/left/leftLayout.html', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="searchPane"></div><div class="selectionPane"></div>');}return __p.join('');}});
